...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private static void checkAndConvertImplicitConfig(MethodConfig method, Map<String, String> map, Map<Object, Object> attributes) {
        ...
        //return attribute must be set true when onreturn or onthrow has been setted
    ...
    private void init() {
        ...
        if (resolve == null || resolve.length() == 0) {
            ...
            //如果没有指定映射文件路径，则新创建个dubbo-resolve.properties
            ...
            //加载resolveFile路径下的文件加载到properties
            if (resolveFile != null && resolveFile.length() > 0) {
                ...
                //获取直连的url dubbo://localhost:20890,有可能为空
        ...
        if (methods != null && !methods.isEmpty()) {
            for (MethodConfig method : methods) {
                ...
                //参见事件通知http://dubbo.apache.org/books/dubbo-user-book/demos/events-notify.html
                appendAttributes(attributes, method, prefix + "." + method.getName());
                // 检查属性集合中的事件通知方法是否正确。若正确，将方法名转换成方法。
    ...
    private T createProxy(Map<String, String> map) {
        ...
        // injvm 属性为空，不通过该属性判断
        if (isInjvm() == null) {
            // 直连服务提供者，参见文档《直连提供者》http://dubbo.apache.org/books/dubbo-user-book/demos/explicit-target.html
