...
public class ByteBufferBackedChannelBuffer extends AbstractChannelBuffer {
    ...
    public ByteBufferBackedChannelBuffer(ByteBuffer buffer) {
        ...
        /**
         * buffer.slice()
         * 返回当前ByteBuf的可读子区域，起始位置从readerIndex到writerIndex，
         * 返回的ByteBuf对象与当前ByteBuf对象共享缓冲区的内容，但是维护自己独立的readerIndex和writerIndex。
         * 该操作不修改原ByteBuf的readerIndex和writerIndex。返回ByteBuf对象的长度为readableBytes()
         */
    ...
    public void getBytes(int index, byte[] dst, int dstIndex, int length) {
        /**
         * buffer.duplicate()
         * 返回当前ByteBuf的复制对象，复制后的ByteBuf对象与当前ByteBuf对象共享缓冲区的内容，
