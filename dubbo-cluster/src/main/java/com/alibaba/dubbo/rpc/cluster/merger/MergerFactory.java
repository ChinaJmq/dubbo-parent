...
/**
 * 提供 #getMerger(Class<T> returnType) 方法，获得指定类对应的 Merger 对象
 */
public class MergerFactory {
    ...
    public static <T> Merger<T> getMerger(Class<T> returnType) {
        ...
        if (returnType.isArray()) {
            ...
            // 获取不到，使用 ArrayMerger
            //isPrimitive()方法主要用来判断Class是否为原始类型（boolean、char、byte、short、int、long、float、double）。
